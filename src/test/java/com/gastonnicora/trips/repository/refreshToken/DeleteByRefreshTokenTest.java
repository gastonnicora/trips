...
public class DeleteByRefreshTokenTest {
    @Autowired
    ...
    @Test
    void shouldDeleteByRefreshToken() {
        User user = new User(
                "username",
                "latName",
                "test@test.com",
        ...
        refreshTokenRepository.deleteByRefreshToken(rt.getRefreshToken());
    ...
    @Test
    void shouldNotDeleteByRefreshTokenIfNotExist() {
